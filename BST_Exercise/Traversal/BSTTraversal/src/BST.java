...
public class BST {
	...
	public static void inOrderRecursion(BSTNode node){
        if (node == null)
            return;
	...
	public void inOrderTraversal(BSTNode root) {
        ...
        while (current != null || !stack.isEmpty()) {
            ...
            // Current must be NULL at this point to skip while loop 
            current = (BSTNode) stack.Top();
            stack.pop();
	...
	public void preOrderTraversal(BSTNode root) {
        ...
        while (current != null || !stack.isEmpty()) {
            while (current != null) {
                //iterate thru left tree while push right tree data in stack
    ...
    public void postOrderTraversalIterative(BSTNode node) {
        ...
        StackNode stack1 = new StackNode();
        StackNode stack2 = new StackNode();
