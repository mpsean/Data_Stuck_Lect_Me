...
class TypingDeadListNTest {
	...
	void testFindWordNotFound1() throws Exception { //1 marks
		TypingDeadListN l = new TypingDeadListN("abcdefg");
		l.findWord("org");
		assertNull(l.start);
		assertNull(l.end);
	}
	...
	void testFindWordFound() throws Exception { //6 marks
		...
		TypingDeadListN l = new TypingDeadListN("abcabcabcabc");
		l.findWord("cab");
	...
	void testRemoveStartOrEndAtHeader() throws Exception { //1 mark
		...
		TypingDeadListN l = new TypingDeadListN("I am Ironman.");
